# encoding: UTF-8
#
# Example script to issue a disambiguate.mpxml request
...
Net::HTTP.start(uri.host, uri.port) do | http |
  ...
  disReq.addPart({"Content-Type" => textMime}, text)
  ...
  when Net::HTTPOK
    ...
    puts "Found senses: "
    body = Zlib::Inflate.new(16+Zlib::MAX_WBITS).inflate(response.parts[1][:body])
